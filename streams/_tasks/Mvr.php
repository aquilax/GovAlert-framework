...
class Mvr extends Task
{
	...
	function mvrNovini()
	{
		$this->loadMVRpage("", "МВР", "новини", 0, "http://press.mvr.bg/default.htm", "http://press.mvr.bg", "govalerteu");
	}

	function mvrKampanii()
	{
		$this->loadMVRpage("", "МВР", "кампании", 1, "http://press.mvr.bg/Kampanii/default.htm", "http://press.mvr.bg");
	}

	function mvrBlagoevgrad()
	{
		$this->loadMVRpage("[Благоевград] ", "МВР Благоевград", "новини", 2, "http://www.blagoevgrad.mvr.bg/Prescentar/Novini/default.htm", "http://www.blagoevgrad.mvr.bg");
	}

	function mvrBlagoevgradIzdirvani()
	{
		$this->loadMVRpage("[Благоевград] ", "МВР Благоевград", "издирвани", 3, "http://www.blagoevgrad.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.blagoevgrad.mvr.bg", "lipsva", true);
	}

	function mvrVarna()
	{
		$this->loadMVRpage("[Варна] ", "МВР Варна", "новини", 5, "http://varna.mvr.bg/Prescentar/Novini/default.htm", "http://varna.mvr.bg");
	}

	function mvrVelikotarnovo()
	{
		$this->loadMVRpage("[В.Търново] ", "МВР В.Търново", "новини", 6, "http://www.veliko-tarnovo.mvr.bg/Prescentar/Novini/default.htm", "http://www.veliko-tarnovo.mvr.bg");
	}

	function mvrVelikotarnovoIzdirvani()
	{
		$this->loadMVRpage("[В.Търново] ", "МВР В.Търново", "изчезнали", 7, "http://www.veliko-tarnovo.mvr.bg/Prescentar/Izdirvani_lica/", "http://www.veliko-tarnovo.mvr.bg", "lipsva", true);
	}

	function mvrVidin()
	{
		$this->loadMVRpage("[Видин] ", "МВР Видин", "новини", 8, "http://www.vidin.mvr.bg/PressOffice/News/default.htm", "http://www.vidin.mvr.bg");
	}

	function mvrVidinIzdirvani()
	{
		$this->loadMVRpage("[Видин] ", "МВР Видин", "изчезнали", 9, "http://www.vidin.mvr.bg/Pressoffice/Izdirvani_lica/default.htm", "http://www.vidin.mvr.bg", "lipsva", true);
	}

	function mvrVraca()
	{
		$this->loadMVRpage("[Враца] ", "МВР Враца", "новини", 10, "http://www.vratza.mvr.bg/PressOffice/News/default.htm", "http://www.vratza.mvr.bg");
	}

	function mvrVracaIzdirvani()
	{
		$this->loadMVRpage("[Враца] ", "МВР Враца", "изчезнали", 11, "http://www.vratza.mvr.bg/Pressoffice/Izdirvani_lica/default.htm", "http://www.vratza.mvr.bg", "lipsva", true);
	}

	function mvrGabrovo()
	{
		$this->loadMVRpage("[Габрово] ", "МВР Габрово", "новини", 12, "http://www.gabrovo.mvr.bg/PressOffice/News/default.htm", "http://www.gabrovo.mvr.bg");
	}

	function mvrGabrovoIzdirvani()
	{
		$this->loadMVRpage("[Габрово] ", "МВР Габрово", "изчезнали", 13, "http://www.gabrovo.mvr.bg/PressOffice/Wanted/default.htm", "http://www.gabrovo.mvr.bg", "lipsva", true);
	}

	function mvrDobrich()
	{
		$this->loadMVRpage("[Добрич] ", "МВР Добрич", "новини", 14, "http://dobrich.mvr.bg/Prescentar/Novini/default.htm", "http://dobrich.mvr.bg");
	}

	function mvrKardjali()
	{
		$this->loadMVRpage("[Кърджали] ", "МВР Кърджали", "новини", 15, "http://www.kardjali.mvr.bg/PressOffice/News/default.htm", "http://www.kardjali.mvr.bg");
	}

	function mvrKardjaliIzdirvani()
	{
		$this->loadMVRpage("[Кърджали] ", "МВР Кърджали", "изчезнали", 16, "http://www.kardjali.mvr.bg/PressOffice/Izirva_se/default.htm", "http://www.kardjali.mvr.bg", "lipsva", true);
	}

	function mvrKiustendil()
	{
		$this->loadMVRpage("[Кюстендил] ", "МВР Кюстендил", "новини", 17, "http://www.kustendil.mvr.bg/PressOffice/News/default.htm", "http://www.kustendil.mvr.bg");
	}

	function mvrLovech()
	{
		$this->loadMVRpage("[Ловеч] ", "МВР Ловеч", "новини", 18, "http://www.lovech.mvr.bg/PressOffice/News/default.htm", "http://www.lovech.mvr.bg");
	}

	function mvrLovechIzdirvani()
	{
		$this->loadMVRpage("[Ловеч] ", "МВР Ловеч", "изчезнали", 19, "http://www.lovech.mvr.bg/PressOffice/Wanted/default.htm", "http://www.lovech.mvr.bg", "lipsva", true);
	}

	function mvrMontana()
	{
		$this->loadMVRpage("[Монтана] ", "МВР Монтана", "новини", 20, "http://www.montana.mvr.bg/PressOffice/News/default.htm", "http://www.montana.mvr.bg");
	}

	function mvrMontanaIzdirvani()
	{
		$this->loadMVRpage("[Монтана] ", "МВР Монтана", "изчезнали", 21, "http://www.montana.mvr.bg/PressOffice/Wanted/default.htm", "http://www.montana.mvr.bg", "lipsva", true);
	}

	function mvrPazardjik()
	{
		$this->loadMVRpage("[Пазарджик] ", "МВР Пазарджик", "новини", 22, "http://pazardjik.mvr.bg/Prescentar/Novini/default.htm", "http://pazardjik.mvr.bg");
	}

	function mvrPazardjikIzdirvani()
	{
		$this->loadMVRpage("[Пазарджик] ", "МВР Пазарджик", "изчезнали", 23, "http://pazardjik.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://pazardjik.mvr.bg", "lipsva", true);
	}

	function mvrPernik()
	{
		$this->loadMVRpage("[Перник] ", "МВР Перник", "новини", 24, "http://www.pernik.mvr.bg/Prescentar/Novini/default.htm", "http://www.pernik.mvr.bg");
	}

	function mvrPernikIzdirvani()
	{
		$this->loadMVRpage("[Перник] ", "МВР Перник", "изчезнали", 25, "http://www.pernik.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.pernik.mvr.bg", "lipsva", true);
	}

	function mvrPleven()
	{
		$this->loadMVRpage("[Плевен] ", "МВР Плевен", "новини", 26, "http://www.pleven.mvr.bg/PressOffice/News/default.htm", "http://www.pleven.mvr.bg");
	}

	function mvrPlevenIzdirvani()
	{
		$this->loadMVRpage("[Плевен] ", "МВР Плевен", "изчезнали", 27, "http://www.pleven.mvr.bg/PressOffice/Wanted/default.htm", "http://www.pleven.mvr.bg", "lipsva", true);
	}

	function mvrRazgrad()
	{
		$this->loadMVRpage("[Разград] ", "МВР Разград", "новини", 29, "http://www.razgrad.mvr.bg/PressOffice/News/default.htm", "http://www.razgrad.mvr.bg");
	}

	function mvrRuse()
	{
		$this->loadMVRpage("[Русе] ", "МВР Русе", "новини", 30, "http://www.ruse.mvr.bg/Prescentar/Novini/default.htm", "http://www.ruse.mvr.bg");
	}

	function mvrRuseIzdirvani()
	{
		$this->loadMVRpage("[Русе] ", "МВР Русе", "изчезнали", 31, "http://www.ruse.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.ruse.mvr.bg", "lipsva", true);
	}

	function mvrSilistra()
	{
		$this->loadMVRpage("[Силистра] ", "МВР Силистра", "новини", 32, "http://www.silistra.mvr.bg/Prescentar/Novini/default.htm", "http://www.silistra.mvr.bg");
	}

	function mvrSilistraIzdirvani()
	{
		$this->loadMVRpage("[Силистра] ", "МВР Силистра", "изчезнали", 33, "http://www.silistra.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.silistra.mvr.bg", "lipsva", true);
	}

	function mvrSliven()
	{
		$this->loadMVRpage("[Сливен] ", "МВР Сливен", "новини", 34, "http://sliven.mvr.bg/Prescentar/Novini/default.htm", "http://sliven.mvr.bg");
	}

	function mvrSlivenIzdirvani()
	{
		$this->loadMVRpage("[Сливен] ", "МВР Сливен", "изчезнали", 35, "http://sliven.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://sliven.mvr.bg", "lipsva", true);
	}

	function mvrSmolqn()
	{
		$this->loadMVRpage("[Смолян] ", "МВР Смолян", "новини", 36, "http://www.smolyan.mvr.bg/Prescentar/Novini/default.htm", "http://www.smolyan.mvr.bg");
	}

	function mvrSmolqnIzdirvani()
	{
		$this->loadMVRpage("[Смолян] ", "МВР Смолян", "изчезнали", 37, "http://www.smolyan.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.smolyan.mvr.bg", "lipsva", true);
	}

	function mvrSofiq()
	{
		$this->loadMVRpage("[София] ", "МВР София", "новини", 38, "http://www.odmvr-sofia.mvr.bg/Prescentar/Novini/default.htm", "http://www.odmvr-sofia.mvr.bg");
	}

	function mvrStaraZagora()
	{
		$this->loadMVRpage("[С.Загора] ", "МВР С.Загора", "новини", 39, "http://www.starazagora.mvr.bg/PressOffice/News/default.htm", "http://www.starazagora.mvr.bg");
	}

	function mvrStaraZagoraIzdirvani()
	{
		$this->loadMVRpage("[С.Загора] ", "МВР С.Загора", "изчезнали", 40, "http://www.starazagora.mvr.bg/PressOffice/Wanted/default.htm", "http://www.starazagora.mvr.bg", "lipsva", true);
	}

	function mvrTargovishte()
	{
		$this->loadMVRpage("[Търговище] ", "МВР Търговище", "новини", 41, "http://targovishte.mvr.bg/Prescentar/Novini/default.htm", "http://targovishte.mvr.bg");
	}

	function mvrHaskovo()
	{
		$this->loadMVRpage("[Хасково] ", "МВР Хасково", "новини", 42, "http://haskovo.mvr.bg/Prescentar/Novini/default.htm", "http://haskovo.mvr.bg");
	}

	function mvrShumen()
	{
		$this->loadMVRpage("[Шумен] ", "МВР Шумен", "новини", 43, "http://www.shumen.mvr.bg/Prescentar/Novini/default.htm", "http://www.shumen.mvr.bg");
	}

	function mvrShumenIzdirvani()
	{
		$this->loadMVRpage("[Шумен] ", "МВР Шумен", "изчезнали", 44, "http://www.shumen.mvr.bg/Prescentar/Izdirvani_lica/default.htm", "http://www.shumen.mvr.bg", "lipsva", true);
	}

	function mvrQmbol()
	{
		$this->loadMVRpage("[Ямбол] ", "МВР Ямбол", "новини", 45, "http://www.yambol.mvr.bg/Prescentar/Novini/default.htm", "http://www.yambol.mvr.bg");
	}

	function mvrQmbolIzdirvani()
	{
		$this->loadMVRpage("[Ямбол] ", "МВР Ямбол", "изчезнали", 46, "http://www.yambol.mvr.bg/Izdirvani_lica/default.htm", "http://www.yambol.mvr.bg", "lipsva", true);
	}
	...
	function mvrBurgas()
	{
		...
		$this->setSession(19, 4);

		$html = $this->loadURL("http://www.rdvr-burgas.org/Bul/Suobshtenie/Realno.htm", 4);
		if (!$html) return;
	...
	function mvrPlovdiv()
	{
		...
		$this->setSession(19, 28);

		$html = $this->loadURL("http://plovdiv.mvr.bg/news.php", 28);
		if (!$html) return;
		$html = mb_convert_encoding($html, 'UTF-8', 'cp1251');
		$xpath = $this->xpath($html);
	...
	function loadMVRpage($prefix, $logtitle, $logwhat, $num, $url, $urlbase, $retweet = false, $expectempty = false)
	{
		...
		$this->setSession(19, $num);

		$html = $this->loadURL($url, $num);
		if (!$html) return;
		$xpath = $this->xpath($html);
