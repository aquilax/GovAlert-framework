...
class Interpol extends Task
{

	function interpolIzcheznali()
	{
		$this->interpolLoad(array(
			"изчезнали", 1,
	...
	{
		$this->interpolProcess(array("изчезнали",
			1,
	...
	{
		$this->interpolProcess(array("издирвани",
			0,
	...
	{
		$this->setSession(18, $prop[1] == 1 ? 1 : 2);
